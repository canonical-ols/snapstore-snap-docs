...
use that HTTPS proxy in order to be able to install the enterprise-storesnap
package.
...
as needed and enterprise-storewill honour these changes by default (it might
